...
- `/play/[slug]` — Session ฝึกเพลงพร้อม Virtual Pin, AI Coach และ Note Timeline
...
- ใช้ปุ่มคีย์บอร์ด `1`, `2`, `3` สำหรับดีดสาย
- สังเคราะห์เสียงแบบ low-latency ด้วย Web Audio API โดยไม่ต้องดาวน์โหลดไฟล์เสียง
- ตรวจโน้ตตามเพลง ให้ feedback คะแนน ความแม่นยำ และเลื่อน Note Timeline
