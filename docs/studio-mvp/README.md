...
หน้า `/studio` เป็นเวอร์ชันแรกสำหรับสาธิตกระบวนการสร้างเพลงจาก Virtual Pin โดยใช้โปรเจกต์คงที่ 8 ห้อง และบันทึกข้อมูลโน้ตเป็นสาย เฟรต จังหวะ และน้ำหนักการดีด

## Demo flow

1. กด `+ เพิ่ม Loop` เพื่อเพิ่ม Isan Demo Beat
2. กด Record และรอ Count-in 1 ห้อง
3. เล่นผ่าน Touch Pin หรือสลับไปใช้ Hand Tracking
...
โปรเจกต์จะ Auto-save ในเบราว์เซอร์ด้วย `localStorage` ภายใต้ key `virtual-pin-studio-v1`
